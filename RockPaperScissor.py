...
#picture
rock_img=ImageTk.PhotoImage(Image.open("rock_player.png"))
paper_img=ImageTk.PhotoImage(Image.open("paper_player.png"))
scissor_img=ImageTk.PhotoImage(Image.open("scissor_player.png"))
rock_img_comp=ImageTk.PhotoImage(Image.open("rock_computer.png"))
paper_img_comp=ImageTk.PhotoImage(Image.open("paper_computer.png"))
scissor_img_comp=ImageTk.PhotoImage(Image.open("scissor_computer.png"))
...
#indicators
user_indicator=Label(root,font=50,text="COMPUTER",bg="#9b59b6",fg="white")
comp_indicator=Label(root,font=50,text="USER",bg="#9b59b6",fg="white")
